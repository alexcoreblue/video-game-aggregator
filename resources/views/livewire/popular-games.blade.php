<div wire:init="loadPopularGames" class="popular-games text-sm grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-12 border-b border-gray-800 pb-16">
    ...
    <div class="game mt-8">
        ...
        <div class="block text-transparent text-lg bg-gray-700 rounded leading-tight mt-6">Title goes here</div>
